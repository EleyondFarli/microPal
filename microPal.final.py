...
def on_forever():
    ...
    if menu == 0:
        ...
        codify()
        if len(solution) == 9:
            serial.write_line("00000000" + solution + keyword)
        elif len(solution) == 13:
            serial.write_line("0000" + solution + keyword)
        else:
            serial.write_line("" + solution + keyword)
        basic.show_icon(IconNames.YES)
        basic.pause(200)
    if menu == 1:
        setTime()
